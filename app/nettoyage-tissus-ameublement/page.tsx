...
const cat = rouenContent.categories.tissus;

export const metadata = generatePageMetadata({
  title: cat.metaTitle,
  description: cat.metaDescription,
  path: '/nettoyage-tissus-ameublement',
});

export default function TissusAmeublementPage() {
  const services = getServicesByCategory('tissus');
  const breadcrumbItems = [
    { label: 'Accueil', href: '/' },
    { label: 'Tissus & Ameublement', href: '/nettoyage-tissus-ameublement' },
  ];
