#!/usr/bin/env python3
"""SEO Phase B - Lot 3 - Fix: distributeurs commerces link"""
import re
...
content, fails = process(content, [
    # Link: commerces (append to L1112 end) — fix: "les pics" not "aux pics"
    ("les pics d\\'utilisation saisonniers et événementiels.'",
     "les pics d\\'utilisation saisonniers et événementiels. Nous assurons aussi l\\'<a href=\"/entretien-commerces-rouen\">entretien de commerces à Rouen</a> pour vos espaces de vente.'",
     'Link: commerces'),
])
